...
const AdminPage = () => {
    ...
    const navItems = [
        ...
        { label: 'Disbursement Records', path: '/admin/disbursementrecords', icon: <PiFileThin size={22} /> },
        { label: 'Disbursement Logs', path: '/admin/disbursementlogs', icon: <PiTableThin size={20} /> },
